...
This module provides a small CLI used by the profiling scripts. It was
previously corrupted by a bad merge; this file is a single, canonical copy
of the original implementation used by the benchmark orchestration.
"""
