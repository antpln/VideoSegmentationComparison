...
def run_with_points(
    ...
    *,
    ...
    try:
        ...
        if not hasattr(predictor, "init_state") or not hasattr(predictor, "add_new_points_or_box"):
            raise AttributeError("SAM2VideoPredictor missing video tracking methods")
        ...
        print(f"[ERROR] SAM2 predictor lacks required video APIs: {exc}")
        raise
